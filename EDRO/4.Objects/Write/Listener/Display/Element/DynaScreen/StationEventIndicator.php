...
class StationEventIndicator
	...
	public static function strObjectInit()
		...
		$str='
		<script>
			var objDynaScreenEventIndicator= new DynaScreenEventIndicator();
		</script>';
		return $str;
		}
	...
	public static function strHTML()
		{
		$objDynaScreenEventIndicator=new DynaScreenEventIndicator($objKIIM);
